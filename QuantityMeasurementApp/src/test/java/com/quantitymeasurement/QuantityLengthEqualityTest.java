...
class QuantityLengthEqualityTest {
    ...
    void testConversion_RoundTrip_PreservesValue() {
        double value = 3.5;
        double toInches = convert(value,
                LengthUnit.FEET, LengthUnit.INCH);
        double backToFeet = convert(toInches,
                LengthUnit.INCH, LengthUnit.FEET);
    ...
    void testConversion_NaNOrInfinite_Throws() {
        assertThrows(IllegalArgumentException.class,
                () -> convert(Double.NaN, LengthUnit.FEET,
                        LengthUnit.INCH),
                "Expected NaN value to be rejected");
        assertThrows(IllegalArgumentException.class,
                () -> convert(Double.POSITIVE_INFINITY, LengthUnit.FEET,
                        LengthUnit.INCH),
    ...
    void testAddition_SameUnit_FeetPlusFeet() {
        QuantityLengthEquality.QuantityLength result = add(
                new  QuantityLengthEquality.QuantityLength(1.0, LengthUnit.FEET),
                new  QuantityLengthEquality.QuantityLength(2.0, LengthUnit.FEET));
    ...
    void testAddition_Commutativity() {
        ...
        QuantityLengthEquality.QuantityLength resultFirst = add(first, second);
        QuantityLengthEquality.QuantityLength resultSecond = add(second, first);

        double firstInFeet = convert(resultFirst.getValue(), resultFirst.getUnit(),
                LengthUnit.FEET);
        double secondInFeet = convert(resultSecond.getValue(), resultSecond.getUnit(),
                LengthUnit.FEET);
    ...
    void testAddition_ExplicitTargetUnit_Commutativity() {
        ...
        QuantityLengthEquality.QuantityLength resultFirst = add(
                first, second, LengthUnit.YARDS);
        QuantityLengthEquality.QuantityLength resultSecond = add(
