...
class QuantityLengthEqualityTest {
    ...
    void testAddition_SameUnit_FeetPlusFeet() {
         Quantity<LengthUnit> result = add(
                new   Quantity<LengthUnit>(1.0, LengthUnit.FEET),
                new   Quantity<LengthUnit>(2.0, LengthUnit.FEET));
    ...
    void testAddition_Commutativity() {
         ...
         Quantity<LengthUnit> resultFirst = add(first, second);
         Quantity<LengthUnit> resultSecond = add(second, first);
    ...
    void testAddition_ExplicitTargetUnit_Commutativity() {
         ...
         Quantity<LengthUnit> resultFirst = add(
                first, second, LengthUnit.YARDS);
         Quantity<LengthUnit> resultSecond = add(
