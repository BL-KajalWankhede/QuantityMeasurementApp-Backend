...
public class QuantityMeasurementEntity {
    ...
    public QuantityMeasurementEntity(OperationType operationType, QuantityDTO leftOperand, QuantityDTO rightOperand, QuantityDTO resultQuantity) {
        this(operationType, leftOperand, resultQuantity);
        applyRightOperand(rightOperand);
    }

    public QuantityMeasurementEntity(OperationType operationType, QuantityDTO leftOperand, QuantityDTO rightOperand, Boolean comparisonResult, Double scalarResult) {
        this.operationType = operationType;
        applyLeftOperand(leftOperand);
        applyRightOperand(rightOperand);
