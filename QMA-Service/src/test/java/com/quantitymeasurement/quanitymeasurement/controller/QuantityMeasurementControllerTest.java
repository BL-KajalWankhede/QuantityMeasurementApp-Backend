package com.quantitymeasurement.quanitymeasurement.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.quantitymeasurement.controller.QuantityMeasurementController;
import com.quantitymeasurement.exception.GlobalExceptionHandler;
...
class QuantityMeasurementControllerTest {
    ...
    void testRestEndpointCompareQuantities() throws Exception {
        ...
        when(quantityMeasurementService.compare(any(QuantityDTO.class), any(QuantityDTO.class)))
    ...
    private record QuantityMeasurementEntityFixture(String operation, String resultString, Double resultValue,
                                                    String resultUnit, String resultMeasurementType,
                                                    boolean error, String errorMessage) {
        private com.quantitymeasurement.model.QuantityMeasurementEntity toEntity() {
            com.quantitymeasurement.model.QuantityMeasurementEntity entity =
                    new com.quantitymeasurement.model.QuantityMeasurementEntity();
